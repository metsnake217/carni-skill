...
app.launch( function( request, response ) {
	...
	response.say( 'Hello, welcome to Carnival.').reprompt("Oh it seems that you are on your way to a fun activity! At least I hope so. Goodbye!").shouldEndSession(false);
...
app.intent('closeSessionQuestion',
	   ...
	   function(request,response) {
	       ...
	       if(answer == 'no'){
	       		...
	       		response.say("Great! Would you want the schedule on other parts of the pool such as the Bar Lola, the restaurant, or the Pool?").reprompt("Hopefully i will be helpful to you soon! our conversation is about to end... it was lovely conversing with you! Goodbye!").shouldEndSession(true);
	       		//response.shouldEndSession(false);
...
app.intent('findSchedule',
	   ...
	   function(request,response) {
		...
		response.say("Anything else i can help you with? otherwise Say 'Alexa Stop' to end our conversation").reprompt("Oh it seems that you are on your way to a fun activity! At least I hope so. it was lovely conversing with you! Goodbye!").shouldEndSession(true);
...
app.intent('closeSessionQuestion',
	   ...
	   function(request,response) {
	       ...
	       if(answer == 'no'){
	       		...
	       		response.say("Great! Say 'location' or 'Location today' or 'All schedules today'?").reprompt("sounds like you are off to a fun activity on the ship! it was lovely conversing with you! Goodbye!").shouldEndSession(true);
	       		//response.shouldEndSession(false);
