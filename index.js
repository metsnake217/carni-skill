...
app.launch( function( request, response ) {
	...
	response.say( 'Hello, welcome to Carnival.').reprompt("Oh it seems that you are on your way to a fun activity! At least I hope so. Goodbye!").shouldEndSession(true);
